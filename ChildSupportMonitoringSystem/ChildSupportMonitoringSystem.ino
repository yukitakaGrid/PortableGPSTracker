...
String str1; 
String str2;
String str_send; //送信用の結合文字
int state; //ボタンの状態遷移
char buttonState; 
unsigned long time_data1; //時間記録開始
unsigned long time_data2; //時間記録終了
bool mail_able; 
...
void sw(void); //スイッチの割り込み処理
void gps1();
 
void setup(void)
{
  pinMode(12,OUTPUT); //ブザーのモード設定
  pinMode(2,INPUT_PULLUP); //ボタンのモード設定
